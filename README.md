...
4. It is first thought for spatial performance with more **global, high-level (indirect) control strategies**, by swinging among scenes of spatialised events and by changing masses of parameters, particularly playback speeds with different mappings according to each controller. 

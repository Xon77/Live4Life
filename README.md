...
1. Install [SuperCollider 3.13](https://supercollider.github.io/downloads) or above. For beginners in SuperCollider, to evaluate a code in parentheses, you have to be inside the parentheses and press Control (on Windows) / Command (on Mac) + Return (for more details go to the menu `Language`), and to evaluate a line of code, you have to be on the specific line and press either Control (on Windows) / Command (on Mac) or shift + Return).

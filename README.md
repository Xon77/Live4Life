...
:warning: **If you attend one of the spatial workshops I organise, it is strongly recommended to have beforehand prepared the first 3 steps of the installation process below and [downloaded a prepared sound folder](https://github.com/Xon77/L4LSoundsDataBase/archive/refs/heads/main.zip)! I will try to help you in the installation of SuperCollider and Quarks, but I cannot guarantee you the success of the installation of Quarks especially on Windows and Linux, since I do not use these platforms.**

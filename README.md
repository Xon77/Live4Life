...
:warning: **If you attend one of the spatial workshops I organise, it is important and strongly recommended to have beforehand prepared at least the 5 steps of the installation process below and [downloaded a prepared sound folder](https://github.com/Xon77/L4LSoundsDataBase/archive/refs/heads/main.zip)! If you want to quickly test or for Windows and Linux users, you can [download this specific prepared folder](https://github.com/Xon77/L4LSoundsDataBaseLight/archive/refs/heads/main.zip).**

...
In order to launch the tool, follow the steps and coming instructions of the file `_0 Init Live4Life.scd` (/_0 Init Live4Life.scd) in the [folder](/4Live4Life_Project) `4Live4Life_Project`.

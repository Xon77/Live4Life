...
4. Put the files of the folder [`4Live4Life_Extensions`](/4Live4Life_Extensions) in your SuperCollider Extensions folder if you do not already have them and recompile again.
...
1. [define and evaluate default configuration parameters](L4L_Project/_0_Init_Live4Life.scd#L1-L101). You mainly have to choose the [absolute path of your sound folder](L4L_Project/_0_Init_Live4Life.scd#L38) and your [spatial configuration and distribution of loudspeakers](L4L_Project/_0_Init_Live4Life.scd#L41-L63) (stereo, quad, circles of 5, 7, 8 loudspeakers, or domes of 16, 24, 32 loudspeakers) or define it by code with `~numChannelsConfig` in the file [`_1_Init_BuffersSynths_130.scd`](/L4L_Project/_1_Init_BuffersSynths_130.scd) if not available.

2. [evaluate a function](L4L_Project/_0_Init_Live4Life.scd#L125) and [load one](L4L_Project/_0_Init_Live4Life.scd#L129) or [two servers](L4L_Project/_0_Init_Live4Life.scd#L133):
...
3. [open a GUI](L4L_Project/_0_Init_Live4Life.scd#L143) (this process may take a dozen seconds) with different tabs like a Sequence view for the composition and the Global view for the performance (see figures above), as well as views for global multichannel and ambisonic effects,

4. [evaluate a pattern function](L4L_Project/_0_Init_Live4Life.scd#L153), that triggers sound events with sequences of parameters for each track, and a routine updating the GUI.

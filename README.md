...
***Live 4 Life* plays on all platforms, but is currently only optimised for macOS.** I have remarked that the buffer loading is very slow on Windows and Linux, requiring more patience.

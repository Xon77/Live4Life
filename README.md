...
2. [evaluate a function](L4L_Project/_0_Init_Live4Life.scd#L126) and [load one](L4L_Project/_0_Init_Live4Life.scd#L130) or [two servers](L4L_Project/_0_Init_Live4Life.scd#L134) (Depending on your computer performance, I recommend to avoid doing a lot of things with your computer, since the loading of a server can be heavy):

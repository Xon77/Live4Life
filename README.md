...
I have been developing in [**SuperCollider**](https://supercollider.github.io) since 2011, ***"to play the place and the music at the same time".*** **Although I hope to develop this tool with other spatial controls and algorithms during the rest of my life, this project is a bit paused** because of several reasons (mainly due to the pandemic and the difficulty to find spatial residencies or perform spatial improvisations in concert halls or festivals without an appropriate allowance). **I am now prioritising rhythm and synthesis over spatial development with a new project based on controlling live coding that can accompany this project** (to be released soon hopefully).
...
2. evaluate [the line 9](L4L_Project/_0A_Init_Live4Life.scd#L9) (to load one server) and [the line 13](L4L_Project/_0A_Init_Live4Life.scd#L13) (to load a second server) ( :warning: **Each step of loading a server may take a few minutes depending on your computer performance. I recommend to avoid doing a lot of things with your computer during this process, since the loading of a server can be heavy.** Each server is attributed to one CPU core, so by having two severs, you can have twice as much CPU power.) for:
...
- at [CIRMMT](https://www.cirmmt.org/en/welcome-to-cirmmt?set_language=en) in Montréal [in March, April](https://www.cirmmt.org/en/events/workshops/research/spatial-sound-live4life?set_language=en) and [November](https://www.cirmmt.org/en/events/workshops/research/live4life_workshop-nov23?set_language=en) 2023 in quadriphony,
- at [Hexagram](https://hexagram.ca/en/demo33-christophe-lengele-live-4-life-or-die/) in Montréal on May 13 and December 3, 2023, and August 3, 2024, on a 32-loudspeaker dome, as well as the first performative participative installations on [May 12](https://bit.ly/3VHaIx2) and [14](https://bit.ly/3HMo0ST) 2023,
- at [ISEA (International Symposium on Electronic Arts)](https://hexagram.ca/fr/hexagram-isea-2023/) in Paris in May 2023 in quadriphony.

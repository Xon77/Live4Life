...
2. [load one](L4L_Project/_0A_Init_Live4Life.scd#L9) and [a second server](L4L_Project/_0A_Init_Live4Life.scd#L13) (**Each step of loading a server may take a few minutes depending on your computer performance. I recommend to avoid doing a lot of things with your computer during this process, since the loading of a server can be heavy.** Each server is attributed to one CPU core, so by having two severs, you can have twice as much CPU power.):
...
3. evaluate [this line](L4L_Project/_0A_Init_Live4Life.scd#L28) (this step may take a dozen seconds), which
	...
	2. [evaluate a pattern function](L4L_Project/_0A_Init_Live4Life.scd#L31), that triggers sound events with sequences of parameters for each track, and a routine updating the GUI (the core of the programme that links the control of synths with the GUI).

...
It was originally designed for both Mac 15" specific screen size (1920×1200), but **the GUI now automatically adapts or scales to any screen size**. It is preferable to select the biggest screen resolution you can, like e.g. 2056×1329 on Mac 16" specific screen size. **Shortcuts are currently conceived for an AZERTY keyboard (Français - Numérique), but other keyboard options will be added in the future.**

...
4. **From the release v0.0.14, you will also need to put in your SuperCollider Extensions folder** a compiled version of some plugins, in this case [Mi UGens](https://github.com/v7b1/mi-UGens), available in [their releases](https://github.com/v7b1/mi-UGens/releases) (For Mac Intel architectures, you have to choose v.0.0.3). To go quicker, you can download **a compiled version for your OS available within the folder [`L4L_ExtensionsUGens`](L4L_ExtensionsUGens/) of this project**. 

:warning: For new Mac architectures with arm64, you will have to compile Mi Ugens yourself with the help of [this repository from Mads Kjeldgaard](https://github.com/madskjeldgaard/sc-plugins-build-scripts) in order to be allowed to load unsigned plugins on macOS. You can also use [this quark from Mads Kjeldgaard](https://github.com/madskjeldgaard/plugins.quark) to install this plugin among others. You will have to install [cmake](https://cmake.org/download/); and if you encounter a cmake error, you can evaluate [the code available in this post within scsynth webpage](https://scsynth.org/t/error-cmake-is-not-installed/8119/7) in the Supercollider editor before installing plugins.. 
...
8. For some spatial configurations (quad, 8, and UQAM-32 loudspeaker setup), if you want to skip the step for creating synthDefs in one of the setup steps (2.i) below, to go quicker, I have already prepared in the folder [`L4L_SynthDefs`](/L4L_SynthDefs/) the 6 folders (for each of the spatial configuration and for each of both servers) you can copy and put into your user support directory, which is accessible via the menu `File -> Open user support directory`. Recompile again.
...
1. [define and evaluate default configuration parameters](L4L_Project/_0_Init_Live4Life.scd#L1-L105):
...
2. [evaluate a function](L4L_Project/_0_Init_Live4Life.scd#L129) and [load one](L4L_Project/_0_Init_Live4Life.scd#L133) or [two servers](L4L_Project/_0_Init_Live4Life.scd#L135) **(This step may take a dozen seconds depending on your computer performance. I recommend to avoid doing a lot of things with your computer during this process, since the loading of a server can be heavy.)**:
...
3. [open a GUI](L4L_Project/_0_Init_Live4Life.scd#L147) (this step may take a dozen seconds) with different widows including tabs in the main window like the [Sequence view](https://github.com/Xon77/Live4Life/wiki/Sequence-View) for the composition or the [Global view](https://github.com/Xon77/Live4Life/wiki/Global-View) for the performance (see figures above), as well as tab views for [global multichannel and ambisonic effects](https://github.com/Xon77/Live4Life/wiki/FX-Views),

...
3. [open a GUI](4Live4Life_Project/_0_Init_Live4Life.scd#L141) with different tabs like a Sequence view for the composition and the Global view for the performance (see below figures), as well as views for global multichannel and ambisonic effects (this process may take a dozen seconds),
